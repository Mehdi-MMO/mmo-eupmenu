...
local Repository = 'https://raw.githubusercontent.com/Mehdi-MMO/mmo-eupmenu/main/version'
    ...
    PerformHttpRequest(Repository, function(Error, NewestVersion, Header)
      if Error == 200 then
        ...
        if NewestVersion ~= Version then
          ...
          print("                  ^2Github Link: ^9https://github.com/Mehdi-MMO/mmo-eupmenu/releases \n\n")
        end
      else
